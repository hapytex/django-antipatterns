...
all: out_ out_/CNAME $(outjss) $(outcsss) out_/antipattern out_/antipatterns out_/pattern out_/pattern out_/troubleshooting $(outhtml) out_/index.html out_/favicon.ico out_/sitemap.xml
...
out_/antipatterns/%.html: antipattern/%.md Makefile templates/easy_template.html
