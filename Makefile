...
all: out_ out_/CNAME $(outjss) $(outcsss) out_/antipattern out_/antipatterns out_/pattern _out/pattern out_/troubleshooting $(outhtml) out_/index.html out_/favicon.ico out_/sitemap.xml
